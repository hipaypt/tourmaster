<?php
	...
	TODO NEXT VERSIONS
	- validate max min value on payment-util
	- auto links for website categories		
	- manual capture 						

	- logo in payment checkout 		10m
	- other order status 			30m
	- styles 						20m
	- documentation
	*/
			...
			$options['hipayprofessional'] = array(
				...
				'options' => array(
					...
					'hipayprofessional-website-category' => array(
						...
						'type' 			=> 'text',	
						'description' 	=> esc_html__('Replace WEBSITE ID in one of the following URLs, according the platform you are using, choosing one of the categories ID.', 'tourmaster') . '<br>' . esc_html__('Live Platform: ', 'tourmaster') . '<br>' . esc_html__('Sandbox Platform: ', 'tourmaster')
					),
